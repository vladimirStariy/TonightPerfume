        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>(builder =>
            {
                ...
                builder.HasData(
                    new Product[]
                    {
                        new Product {Product_ID = 1, Name = "Product #1", Category_ID = 1, Brand_ID = 1, Country="США", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 2, Name = "Product #2", Category_ID = 1, Brand_ID = 2, Country="Франция", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 3, Name = "Product #3", Category_ID = 1, Brand_ID = 3, Country="Италия", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 4, Name = "Product #4", Category_ID = 1, Brand_ID = 1, Country="США", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 5, Name = "Product #5", Category_ID = 1, Brand_ID = 2, Country="Франция", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 6, Name = "Product #6", Category_ID = 1, Brand_ID = 3, Country="Италия", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 7, Name = "Product #7", Category_ID = 1, Brand_ID = 1, Country="США", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 8, Name = "Product #8", Category_ID = 1, Brand_ID = 2, Country="Франция", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 9, Name = "Product #9", Category_ID = 1, Brand_ID = 3, Country="Италия", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 10, Name = "Product #10", Category_ID = 1, Brand_ID = 1, Country="США", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 11, Name = "Product #11", Category_ID = 1, Brand_ID = 2, Country="Франция", Year="2010", Description="Описание", isPopular=true},
                        new Product {Product_ID = 12, Name = "Product #12", Category_ID = 1, Brand_ID = 3, Country="Италия", Year="2010", Description="Описание", isPopular=true},
